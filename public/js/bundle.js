...
var CharacterActions = function () {
  function CharacterActions() {
    ...
    this.generateActions('reportSucess', 'reportFail', 'getCharacterSuccess', 'getCharacterFail');
  }
...
var StatsActions = function () {
  function StatsActions() {
    ...
    this.generateActions('getStatsSucess', 'getStatsFail');
  }
...
var CharacterStore = function () {
  ...
  _createClass(CharacterStore, [{
    ...
    value: function onGetCharacterSuccess(data) {
      ...
      $(document.body).attr('class', 'profile ' + this.race.toLocaleLowerCase());
      ...
      // If is NaN (from division by zero) then set if to '0'
      this.winLossRatio = (this.win / (this.wins + this.losses) * 100 || 0).toFixed(1);
    }
  }, {
    key: 'onReportSuccess',
